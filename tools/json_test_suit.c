...
const TestCase test_parsing_cases[] = {
    ...
    { "i_string_UTF8_surrogate_U+D800.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    ...
    { "i_string_not_in_unicode_range.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    ...
    { "n_array_comma_after_close.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    ...
    { "n_string_single_doublequote.json", PLAIN_JSON_DONE },
    ...
    { "n_structure_double_array.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    ...
    { "n_structure_object_with_trailing_garbage.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    ...
    { "n_structure_whitespace_formfeed.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    ...
    { "y_array_false.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    { "y_array_heterogeneous.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    { "y_array_null.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    { "y_array_with_1_and_newline.json", PLAIN_JSON_DONE },
    { "y_array_with_leading_space.json", PLAIN_JSON_DONE },
    { "y_array_with_several_null.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    ...
    { "y_number_real_capital_e.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    { "y_number_real_capital_e_neg_exp.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    { "y_number_real_capital_e_pos_exp.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
    ...
    { "y_string_nonCharacterInUTF-8_U+10FFFF.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    { "y_string_nonCharacterInUTF-8_U+FFFF.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    { "y_string_null_escape.json", PLAIN_JSON_DONE },
    { "y_string_one-byte-utf-8.json", PLAIN_JSON_DONE },
    { "y_string_pi.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    { "y_string_reservedCharacterInUTF-8_U+1BFFF.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    ...
    { "y_string_u+2028_line_sep.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    { "y_string_u+2029_par_sep.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    ...
    { "y_string_unicode_2.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    ...
    { "y_string_utf8.json", PLAIN_JSON_ERROR_STRING_INVALID_UTF8 },
    ...
    { "y_structure_true_in_array.json", PLAIN_JSON_ERROR_UNEXPECTED_TOKEN },
